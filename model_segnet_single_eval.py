...
# Predefined paths
pretrained_model_path = '/home/park/MTL/KD4MTL/SegNet-single/segnet_single_model_task_{}_'.format(opt.task) + 'model_best.pth.tar'
